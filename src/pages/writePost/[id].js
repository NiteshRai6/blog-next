...
export default function WritePost({ data }) {
    // console.log(data)
    ...
    const [post_des, setPost_des] = useState(data[0]?.post_des);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.put(`${process.env.NEXT_PUBLIC_URL}/api/post/${navigate.query.id}`,
        ...
        <div className=''>
            ...
            <div className='grid justify-center items-center'>
                ...
                <div className='grid gap-5 bg-[#3cb371] p-10 my-5'>
                    ...
                    <h1 className='text-white text-3xl'>Update Post</h1>

                    <form className='grid gap-5'>

                        <input value={post.post_title} className='p-2 text-lg' required type='text' name='post_title' placeholder='Post Title' onChange={handleChange} />

                        <div className='bg-white'>

                            <ReactQuill className='' theme="snow" name='post_des' placeholder='Description'
                                onChange={(value) =>
                                    setPost_des(value)
                                }
                                modules={modules}
...
export async function getServerSideProps(context) {
    ...
    try {
        const res = await axios.get(`${process.env.NEXT_PUBLIC_URL}/api/post/${query.id}`, { withCredentials: true });
